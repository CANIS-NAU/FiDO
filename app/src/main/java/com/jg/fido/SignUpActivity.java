...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button B_signUp = (Button) findViewById(R.id.signUp1);
    ...
    private void sendRequestWithHttpURLConnection() {
        new Thread(new Runnable(){
            ...
            public void run(){
                ...
                EditText editText_Name = (EditText) findViewById(R.id.Name);
                String Name = editText_Name.getText().toString();
                EditText editText_ID = (EditText) findViewById(R.id.ID);
                String ID = editText_ID.getText().toString();
                EditText editText_Email = (EditText) findViewById(R.id.Email);
                ...
                try{
                    ...
                    URL url = new URL("http://10.18.92.121:5000/testReg?"+"username="+Name+"&password="+Password+"&email="+Email);
